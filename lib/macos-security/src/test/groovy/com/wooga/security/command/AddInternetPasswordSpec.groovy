...
@Requires({ os.macOs })
class AddInternetPasswordSpec extends AddPasswordSpec<AddInternetPassword> {
    AddInternetPassword command

    def setup() {
        command = new AddInternetPassword(testAccount, testServiceOrServer, testPassword)
    ...
    def "property sets commandline"() {
        ...
        "port"               | "-P"            | 4444
        "protocol"           | "-r"            | "https"
        "authenticationType" | "-t"            | "someAuthType"
